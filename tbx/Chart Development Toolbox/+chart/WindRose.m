classdef WindRose < matlab.graphics.chartcontainer.ChartContainer
    ...
    properties ( Constant, GetAccess = private )
        ...
        DirectionLookup = containers.Map( chart.WindRose.RayAngles, ...
            ["N", "NNE", "NE", "ENE", ...
            "E", "ESE", "SE", "SSE", ...
            "S", "SSW", "SW", "WSW", ...
            "W", "WNW", "NW", "NNW"] )
...
labText = string( values( chart.WindRose.DirectionLookup, angles ) );
...
angles = num2cell( chart.WindRose.RayAngles );
directions = values( chart.WindRose.DirectionLookup, angles );
