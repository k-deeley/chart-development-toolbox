classdef Annulus < matlab.ui.componentcontainer.ComponentContainer
    ...
    properties ( Access = private, Transient, NonCopyable )
        ...
        WedgeGraphics(:, 6) = gobjects( 0, 6 )
        % Text objects used for the wedge labels.
        WedgeLabels(:, 1) matlab.graphics.primitive.Text
        % Check box for exploded wedges.
        ExplodedCheckBox(1, 1) matlab.ui.control.CheckBox
        % Check box for the label visibility.
        VisibleLabelsCheckBox(1, 1) matlab.ui.control.CheckBox
        % Check box for the label percentages.
        LabelPercentagesCheckBox(1, 1) matlab.ui.control.CheckBox
        % Check box for the legend visibility.
        LegendVisibleCheckBox(1, 1) matlab.ui.control.CheckBox
        % Check box for the legend percentages.
        LegendPercentagesCheckBox(1, 1) matlab.ui.control.CheckBox
        % Check box for the legend box.
        LegendBoxCheckBox(1, 1) matlab.ui.control.CheckBox
        % Dropdown menu for the legend location.
        LegendLocationDropDown(1, 1) matlab.ui.control.DropDown
        % Spinnder for the number of columns in the legend.
        LegendNumColumnsSpinner(1, 1) matlab.ui.control.Spinner
        % Dropdown menu for the legend orientation.
        LegendOrientationDropDown(1, 1) matlab.ui.control.DropDown
    ...
    methods
        ...
        function set.LabelText( obj, value )
            ...
            assert( length( value ) == length( obj.Data_ ), ...
                "Annulus:LabelTextLengthMismatch", ...
        ...
        function set.LegendText( obj, value )
            ...
            % Check that we have the right number of strings.
            assert( length( value ) == length( obj.Data_ ), ...
                "Annulus:LegendTextLengthMismatch", ...
