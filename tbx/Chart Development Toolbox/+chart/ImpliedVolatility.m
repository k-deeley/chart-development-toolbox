classdef ImpliedVolatility < matlab.ui.componentcontainer.ComponentContainer
...
if ~isempty( t )
    ...
    validateattributes( expiryTime, "double", ...
        ...
        "ImpliedVolatility/mustBeOptionData", "the expiry times" )
    strike = t{:, 2};
    validateattributes( strike, "double", ...
        ["vector", "real", "finite", "positive"], ...
        "ImpliedVolatility/mustBeOptionData", "the strike prices" )
    volatility = t{:, 3};
    validateattributes( volatility, "double", ...
        {"vector", "real", "finite", "positive", "<=", 100}, ...
        "ImpliedVolatility/mustBeOptionData", "the volatilities" )
    assetPrice = t{:, 4};
    validateattributes( assetPrice, "double", ...
        ["vector", "real", "finite", "positive"], ...
        "ImpliedVolatility/mustBeOptionData", "the asset prices" )
