classdef WindRoseChart < matlab.graphics.chartcontainer.ChartContainer
    ...
    properties
        ...
        DirectionLabelFontSize = 10
        % Direction label font weight.
        DirectionLabelFontWeight = "normal"
        % Direction label font angle.
        DirectionLabelFontAngle = "normal"
        % Direction label visibility.
        DirectionLabelVisible = "on"
        ...
        EdgeAlpha = 1
        % Backdrop color.
        BackdropColor = [0.8725, 0.8725, 0.8725]
        % Backdrop line width.
        BackdropLineWidth = 0.5
        % Backdrop line style.
        BackdropLineStyle = "-"
        % Radial label font size.
        RadialLabelFontSize = 8
        % Radial label font weight.
        RadialLabelFontWeight = "normal"
        % Radial label font angle.
        RadialLabelFontAngle = "normal"
        % Radial label visibility.
        RadialLabelVisible = "on"
        % Legend location.
        ...
        LegendVisible = "on"
        % Legend edge color.
        LegendEdgeColor = [0.15, 0.15, 0.15]
        % Legend font angle.
    ...
    methods
        ...
        function set.FaceColors( obj, value )
            ...
            assert( numColors == size( obj.Patches, 2 ), ...
...
angles = num2cell( [90:-22.5:0, 337.5:-22.5:112.5] );
labText = string( values( WindRoseChart.DirectionLookup, angles ) );
...
angles = num2cell( WindRoseChart.RayAngles );
directions = values( WindRoseChart.DirectionLookup, angles );
mustBeMember( d, directions )
