classdef ChartBrowserModel < handle
    ...
    methods
        ...
        function obj = ChartBrowserModel()
            ...
            docFolder = fullfile( chartsRoot(), "doc" );            
            docFilesInfo = struct2table( dir( ...
                fullfile( docFolder, "*.m" ) ) );
            docFiles = string( docFilesInfo.name );            
            obj.DocumentationNames = extractBefore( docFiles, ".m" );            
        ...
        function path = fullpath( obj, file, type )
            ...
            switch type
                ...
                case "html"
                    path = fullfile( chartsRoot(), "app", "html", ...
                        folder, file + ".html" );
            end % switch/case
