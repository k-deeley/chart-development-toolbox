function app = chartBrowserLauncher()
%CHARTBROWSERLAUNCHER Launch the Chart Browser application.
...
uihtml( g, "HTMLSource", fullfile( chartsRoot(), "app", "html", "doc", "GettingStartedApp.html" ) );

% Make the app visible.
app.Visible = true;

end % chartBrowserLauncher
